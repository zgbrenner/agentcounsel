...
| Command | Skill | Trigger phrases | Required inputs | Expected output | Related |
|---|---|---|---|---|---|
| `/trusts-estates:planning-intake` | `skills/trusts-estates/estate-planning-intake/SKILL.md` | "estate planning intake" | Client, jurisdiction, family and asset facts, planning goals | Intake summary + planning issue map | `/trusts-estates:document-summary`, `/trusts-estates:inventory` |
| `/trusts-estates:document-summary` | `skills/trusts-estates/estate-document-summary/SKILL.md` | "summarize this will or trust" | The document(s), the user's role, review purpose | Source-cited summary + key terms table | `/trusts-estates:beneficiary-review` |
| `/trusts-estates:probate-checklist` | `skills/trusts-estates/probate-document-checklist/SKILL.md` | "probate document checklist" | Decedent, fiduciary role, jurisdiction, documents collected | Document checklist + missing-documents list | `/trusts-estates:post-death-tracker` |
| `/trusts-estates:trust-admin-tracker` | `skills/trusts-estates/trust-administration-tracker/SKILL.md` | "trust administration tracker" | Trust instrument, trustee, assets, beneficiaries, accountings | Administration task tracker | `/trusts-estates:fiduciary-issues` |
| `/trusts-estates:fiduciary-issues` | `skills/trusts-estates/fiduciary-duty-issue-spotter/SKILL.md` | "fiduciary duty issue spotting" | The fiduciary, role, jurisdiction, conduct facts and documents | Fiduciary-duty issue matrix | `/trusts-estates:trust-admin-tracker` |
| `/trusts-estates:beneficiary-review` | `skills/trusts-estates/beneficiary-designation-review/SKILL.md` | "review beneficiary designations" | Designation and TOD/POD forms, account records, estate documents | Designation table + inconsistency list | `/trusts-estates:trust-funding` |
| `/trusts-estates:inventory` | `skills/trusts-estates/asset-liability-inventory-builder/SKILL.md` | "build an estate asset inventory" | Asset and liability records, owner/title facts, role | Inventory table + missing-facts list | `/trusts-estates:planning-intake` |
| `/trusts-estates:capacity-facts` | `skills/trusts-estates/capacity-undue-influence-facts-organizer/SKILL.md` | "organize capacity or undue influence facts" | Records, documents, execution and relationship facts, role | Facts chronology + red-flag themes | `/trusts-estates:litigation-chronology` |
| `/trusts-estates:litigation-chronology` | `skills/trusts-estates/estate-litigation-facts-chronology/SKILL.md` | "estate or trust litigation chronology" | Documents, records, correspondence, dispute type, role | Source-cited factual chronology | `/trusts-estates:capacity-facts` |
...
| Command | Skill | Trigger phrases | Required inputs | Expected output | Related |
|---|---|---|---|---|---|
| `/family-law:matter-intake` | `skills/family-law/family-law-matter-intake/SKILL.md` | "intake this family law matter" | Parties and roles, matter type, case stage, jurisdiction, issues, safety concerns | Intake summary + issue map | `/family-law:divorce-intake` |
| `/family-law:divorce-intake` | `skills/family-law/divorce-intake-organizer/SKILL.md` | "organize this divorce" | Marriage/separation dates, children, income, assets, debts, posture | Divorce facts table + issue map | `/family-law:asset-debt-schedule` |
| `/family-law:custody-chronology` | `skills/family-law/custody-parenting-facts-chronology/SKILL.md` | "build a custody chronology" | Communications, records, incident notes, orders, schedules | Custody/parenting chronology | `/family-law:parenting-schedule` |
| `/family-law:parenting-schedule` | `skills/family-law/parenting-schedule-facts-organizer/SKILL.md` | "organize the parenting schedule facts" | Current/proposed schedule, school, transportation, holidays, distance | Schedule facts table + conflict list | `/family-law:custody-order-review` |
| `/family-law:child-support-intake` | `skills/family-law/child-support-facts-intake/SKILL.md` | "child support facts intake" | Jurisdiction, children, income facts, costs, existing orders | Support facts intake table | `/family-law:spousal-support-intake` |
| `/family-law:spousal-support-intake` | `skills/family-law/spousal-support-facts-intake/SKILL.md` | "spousal support facts intake" | Jurisdiction, duration, income, expenses, employment, disclosures | Support facts intake table | `/family-law:asset-debt-schedule` |
| `/family-law:asset-debt-schedule` | `skills/family-law/asset-debt-schedule-builder/SKILL.md` | "build a property and debt schedule" | Statements, deeds, account and loan records, user-provided values | Asset/debt schedule | `/family-law:divorce-intake` |
| `/family-law:dv-referral` | `skills/family-law/domestic-violence-safety-referral-checklist/SKILL.md` | "domestic violence safety referral checklist" | Safety concerns, protective orders, records, court dates | Safety/escalation flags + referral checklist | `/family-law:matter-intake` |
| `/family-law:discovery-tracker` | `skills/family-law/family-law-discovery-tracker/SKILL.md` | "track family law discovery" | Discovery set, response status, deficiencies, role | Discovery tracker | `/family-law:hearing-prep` |
| `/family-law:settlement-issues` | `skills/family-law/settlement-agreement-issue-spotter/SKILL.md` | "issue-spot this settlement agreement" | Agreement text, parties, matter type, jurisdiction | Key terms table + issue list | `/family-law:custody-order-review` |
| `/family-law:custody-order-review` | `skills/family-law/custody-order-review-checklist/SKILL.md` | "review this custody order" | Order text, parties, children, jurisdiction | Order-clarity checklist + ambiguity table | `/family-law:custody-chronology` |
| `/family-law:hearing-prep` | `skills/family-law/family-law-hearing-prep-checklist/SKILL.md` | "family law hearing prep checklist" | Hearing type, pleadings, declarations, exhibits, witnesses | Hearing-prep checklist | `/family-law:discovery-tracker` |
