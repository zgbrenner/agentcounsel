...
| `/m-and-a:tsa-review` | `skills/m-and-a/transition-services-agreement-review/SKILL.md` | "review this TSA", "review the transition services agreement" | The TSA, the purchase agreement/deal perimeter, the side | Service-schedule matrix and TSA-to-purchase-agreement consistency check | `/m-and-a:purchase-agreement`, `/m-and-a:closing-tracker` |
