...
| `matter-workspaces/bankruptcy-matter.md` | Bankruptcy or restructuring matter — debtor-side, creditor-side, or committee | `skills/bankruptcy-restructuring/bankruptcy-matter-intake/SKILL.md`, `skills/bankruptcy-restructuring/bankruptcy-deadline-tracker-intake/SKILL.md`, `skills/bankruptcy-restructuring/automatic-stay-issue-spotter/SKILL.md`, `skills/bankruptcy-restructuring/creditor-claim-intake/SKILL.md`, `skills/bankruptcy-restructuring/proof-of-claim-checklist/SKILL.md`, `skills/bankruptcy-restructuring/executory-contract-assumption-rejection-checklist/SKILL.md`, `skills/bankruptcy-restructuring/cash-collateral-dip-financing-issue-spotter/SKILL.md`, `skills/bankruptcy-restructuring/plan-disclosure-statement-issue-spotter/SKILL.md` |
| `matter-workspaces/family-law-matter.md` | Family law matter — divorce, custody, support, or related dispute (high-sensitivity; safety screening first) | `skills/family-law/matter-intake/SKILL.md`, `skills/family-law/domestic-violence-safety-referral-checklist/SKILL.md`, `skills/family-law/divorce-intake-organizer/SKILL.md`, `skills/family-law/custody-parenting-facts-chronology/SKILL.md`, `skills/family-law/asset-debt-schedule-builder/SKILL.md`, `skills/family-law/child-support-facts-intake/SKILL.md`, `skills/family-law/spousal-support-facts-intake/SKILL.md`, `skills/family-law/settlement-agreement-issue-spotter/SKILL.md` |
| `matter-workspaces/trusts-estates-matter.md` | Estate planning or estate/trust administration matter | `skills/trusts-estates/estate-planning-intake/SKILL.md`, `skills/trusts-estates/estate-document-summary/SKILL.md`, `skills/trusts-estates/asset-liability-inventory-builder/SKILL.md`, `skills/trusts-estates/beneficiary-designation-review/SKILL.md`, `skills/trusts-estates/probate-document-checklist/SKILL.md`, `skills/trusts-estates/post-death-administration-task-tracker/SKILL.md`, `skills/trusts-estates/capacity-undue-influence-facts-organizer/SKILL.md`, `skills/trusts-estates/fiduciary-duty-issue-spotter/SKILL.md` |
