...
AgentCounsel now has 66 canonical skills across 12 practice areas plus two cross-cutting skill groups, and `THIRD_PARTY_NOTICES.md` records the upstream attribution chain.
