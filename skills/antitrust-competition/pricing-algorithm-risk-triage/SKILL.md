...
- Facts for: data inputs/outputs, vendor role, user control, competitor overlap, pricing recommendations, human override, audit logs, data retention, benchmarking, and independent decision-making records.
...
3. **Primary Deliverable:** risk triage matrix, vendor diligence questions, safeguards for attorney review, and missing-information list.
...
**Example request:** "Run pricing-algorithm-risk-triage for this matter and prepare a source-cited draft for supervising counsel."
