...
- Facts for: horizontal overlap, vertical relationships, potential/nascent competition, data/IP, labor markets, roll-up strategy, minority ownership, board rights, information sharing, HSR/foreign filing questions, gun jumping, and integration planning.
...
3. **Primary Deliverable:** antitrust issue list, filing/fact questions for counsel, diligence request list, integration guardrails, and verification checklist.
...
**Example request:** "Run merger-antitrust-issue-spotter for this matter and prepare a source-cited draft for supervising counsel."
