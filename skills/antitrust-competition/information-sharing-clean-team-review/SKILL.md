...
- Facts for: data type, granularity, age, aggregation, recipients, purpose, safeguards, access controls, retention, privilege/confidentiality, clean-team membership, and use restrictions.
...
3. **Primary Deliverable:** information-sharing inventory, clean-team gap table, escalation list, and attorney verification questions.
