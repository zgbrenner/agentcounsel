...
**This skill does:** flag immediate safety and escalation concerns; point to emergency services and qualified local crisis and support resources when danger is indicated; organize described incidents, existing orders, and available records; build a document checklist and an attorney/local-resource referral checklist; and list missing facts.

**This skill does not:** create a safety plan or safety strategy; advise confrontation, evidence-gathering, surveillance, recording, or any step that could increase danger; determine whether abuse or domestic violence occurred; assess credibility; recommend or prepare a protective order or court form; describe protective-order procedures, eligibility, or standards; provide crisis counseling or therapy advice; or constitute legal advice.
...
**Example request:** "Run domestic-violence-safety-referral-checklist on this fictional matter where a client has raised a safety concern and there is an existing protective order, and organize it for the attorney."

**Expected output shape:** an immediate safety notice (placed first if danger is indicated, pointing to emergency services and a qualified local crisis resource); a capability notice; a gates table; neutrally recorded safety/escalation flags; an existing-orders-and-incidents section; a document checklist; an attorney/local-resource referral checklist; a missing-facts list; and verification questions — with no safety plan, no advice to confront or gather evidence, no determination that abuse occurred, no protective-order procedures, no computed deadline, and no invented law.
