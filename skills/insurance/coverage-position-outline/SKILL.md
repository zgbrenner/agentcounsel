...
**This skill does:** organize the policy and claim materials into the skeleton of a coverage analysis — facts, provisions, candidate coverage grants, candidate exclusions and endorsements, conditions, posture, open issues, and recommended questions for counsel — all source-cited.

**This skill does not:** decide whether a claim is covered; conclude on a duty to defend or indemnify; decide which exclusion or endorsement applies; resolve ambiguity; draft a coverage opinion or a final denial letter; recommend that coverage be granted or denied; or constitute legal advice.
...
**Example request:** "Run coverage-position-outline on this fictional professional liability policy and claim file — assemble the outline for our coverage attorney; do not decide coverage."

**Expected output shape:** a gates table, a source-cited facts section, a policy-provisions section, candidate coverage grants and candidate exclusions framed as questions, a conditions section, a posture statement, open issues, and a verification checklist — with no coverage or duty-to-defend/indemnify conclusion, no final denial or opinion, no computed deadline, and no invented authority.
