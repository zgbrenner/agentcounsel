...
**This skill does:** identify coverage issues from the provided policy and claim materials; map each issue to the policy provision and claim fact that raises it, with citations; flag missing facts; and prepare document requests and verification questions.

**This skill does not:** determine whether a claim is covered; decide a duty to defend or indemnify; conclude on exclusions, endorsements, additional insured status, allocation, other-insurance priority, limits or SIR exhaustion, late notice, waiver, estoppel, or prejudice; predict coverage litigation outcomes; or constitute legal advice.
...
**Example request:** "Run coverage-issue-spotter on this fictional CGL policy and the tender and complaint — map the coverage issues for our coverage counsel; do not decide coverage."

**Expected output shape:** a gates table, a coverage issue matrix, a source-cited policy/claim fact table, a missing-facts list, a document request list, and attorney verification questions — with every issue framed as an open question, no coverage or duty-to-defend/indemnify conclusion, no computed deadline, and no invented authority.
