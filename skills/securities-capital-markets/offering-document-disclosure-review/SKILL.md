...
description: "Use when performing offering disclosure review as draft work product for attorney review."
...
Review offering disclosure documents for completeness, consistency, and source-cited issue spotting without certifying compliance. This skill provides **draft work product for attorney review only** and is **not legal advice**.
...
- The user requests offering disclosure review.
