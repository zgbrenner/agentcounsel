...
description: "Use when performing Form D and blue sky tracking as draft work product for attorney review."
...
Build a source-grounded tracker for Form D and state notice workflow facts without determining obligations or deadlines. This skill provides **draft work product for attorney review only** and is **not legal advice**.

## Use When

- The user requests Form D and blue sky tracking.
...
- Issuer.
- Offering date facts [deadline verification required].
- Investor-residence jurisdictions.
- Investor type.
- Offering amount.
