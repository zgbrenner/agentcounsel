...
description: "Use when performing capital markets closing checklist as draft work product for attorney review."
...
Build a capital-markets closing deliverables tracker with ownership, dependencies, and verification gates. This skill provides **draft work product for attorney review only** and is **not legal advice**.
...
- The user requests capital markets closing checklist.
...
- Issuer approvals.
- Underwriter/placement agent documents.
- Purchase/underwriting agreement.
- Legal opinions.
...
- Auditor bring-downs.
- Lock-ups.
- Transfer agent/DTC/legend matters.
- Board/shareholder approvals (if provided).
- Exchange/listing items (if provided).
- FINRA items (if provided).
- Form D/blue sky for private offering.
- Prospectus/filing items for public offering.
- Closing funds flow.
