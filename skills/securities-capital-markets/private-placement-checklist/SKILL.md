...
description: "Use when performing private placement checklist as draft work product for attorney review."
...
Build a private-placement process checklist by workstream, ownership, priority, source, gaps, and attorney-verification items. This skill provides **draft work product for attorney review only** and is **not legal advice**.

## Use When

- The user requests private placement checklist.
