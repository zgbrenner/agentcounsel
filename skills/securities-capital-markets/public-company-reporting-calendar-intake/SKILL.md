...
description: "Use when performing public company reporting calendar intake as draft work product for attorney review."
...
Intake facts needed to draft or review a public-company reporting workflow calendar without computing deadlines. This skill provides **draft work product for attorney review only** and is **not legal advice**.
...
- The user requests public company reporting calendar intake.
...
- Filer status.
- Fiscal year end.
- Exchange/listing status if provided.
- Reporting forms.
- Board/committee cadence.
- Earnings release process.
- Proxy/annual meeting timing.
- Section 16 workflows.
