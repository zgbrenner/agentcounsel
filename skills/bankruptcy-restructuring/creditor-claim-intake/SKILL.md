...
**This skill does:** confirm gates; build a source-cited claim facts table;
record the amount and any characterization as stated by the user; flag
disputes; list missing documents; and prepare attorney verification questions.

**This skill does not:** determine whether a claim is valid, allowable, secured,
or entitled to priority; determine claim amount; advise on filing a claim;
calculate a bar date; or constitute legal advice.
...
unpaid invoices by a company in bankruptcy; organize the claim facts for
counsel."

**Expected output shape:** a gates table, a source-cited claim facts table with
the amount recorded as stated, dispute flags framed as questions, missing-facts
and document-request lists, and verification questions — with no claim
validity, priority, or secured-status conclusion and no computed amount.
