...
**This skill does:** locate and map the indemnification, escrow, and survival
architecture an agreement sets out; summarize the recovery mechanics — caps,
baskets, escrow, special indemnities, claim procedures, setoff, and exclusive
remedy — as the agreement states them; organize a buyer/seller risk matrix and
a recovery waterfall; cite where each element appears; and flag what is
missing, not found, or ambiguous.

**This skill does not:** conclude whether any term is "market standard,"
"typical," or "off-market"; determine whether any provision is legally
enforceable; reach a tax conclusion on a tax indemnity or its treatment;
decide whether the indemnity or escrow package is adequate or acceptable;
compute, confirm, or assume any survival period, claim deadline, or escrow
release date; supply jurisdiction-specific law, securities, antitrust, tax, or
employment rules; or draft final clause language. Whether the package is
sufficient, enforceable, or market is a judgment for the attorney — this skill
reports what the agreement says and flags the questions.
...
**Example request:** "Review the indemnification and escrow provisions in this
stock purchase agreement. We are the buyer; RWI is the primary recovery; here
is the text of Article 8 and the escrow terms."

**Expected output shape:** a document summary stating the buyer-side
perspective, the deal type, and that RWI is in play; an indemnity architecture
table with a source citation per row — survival periods and the escrow release
date each flagged `[deadline verification required]`, and the general cap,
basket, and escrow amounts reported as the agreement's own figures with no
market rating; a recovery waterfall setting out, in the agreement's stated
order, the per-claim threshold, the basket, escrow, RWI, and the seller's
direct exposure to the cap, with any unstated interaction marked `Ambiguous`; a
buyer/seller risk matrix from the buyer side; a buyer-side negotiation
checklist with suggested directions; a list of ambiguities and gaps, including
any undefined "fraud"; and the attorney verification checklist. No figure is
called market standard, no survival or release date is computed, the tax
indemnity is reported without a tax conclusion, and no judgment is offered on
whether the package is adequate.
