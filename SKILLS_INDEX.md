...
| Trusts & Estates | Estate Planning Intake | `skills/trusts-estates/estate-planning-intake/SKILL.md` | Capturing the facts of an estate-planning matter | Client, jurisdiction, family and asset facts, planning goals | Intake summary + planning issue map |
| Trusts & Estates | Estate Document Summary | `skills/trusts-estates/estate-document-summary/SKILL.md` | Summarizing a will, trust, or related estate document | The document(s), the user's role, review purpose | Source-cited summary + key terms table |
| Trusts & Estates | Probate Document Checklist | `skills/trusts-estates/probate-document-checklist/SKILL.md` | Building a probate document checklist for attorney review | Decedent, fiduciary role, jurisdiction, documents collected | Document checklist + missing-documents list |
| Trusts & Estates | Trust Administration Tracker | `skills/trusts-estates/trust-administration-tracker/SKILL.md` | Tracking trust administration tasks | Trust instrument, trustee, assets, beneficiaries, accountings | Administration task tracker |
| Trusts & Estates | Fiduciary Duty Issue Spotter | `skills/trusts-estates/fiduciary-duty-issue-spotter/SKILL.md` | Issue-spotting potential fiduciary-duty questions | The fiduciary, role, jurisdiction, conduct facts and documents | Fiduciary-duty issue matrix |
| Trusts & Estates | Beneficiary Designation Review | `skills/trusts-estates/beneficiary-designation-review/SKILL.md` | Reviewing beneficiary designations and account titling | Designation and TOD/POD forms, account records, estate documents | Designation table + inconsistency list |
| Trusts & Estates | Asset Liability Inventory Builder | `skills/trusts-estates/asset-liability-inventory-builder/SKILL.md` | Building a source-cited estate or trust asset and liability inventory | Asset and liability records, owner/title facts, role | Inventory table + missing-facts list |
| Trusts & Estates | Capacity Undue Influence Facts Organizer | `skills/trusts-estates/capacity-undue-influence-facts-organizer/SKILL.md` | Organizing the facts around capacity and undue-influence questions | Records, documents, execution and relationship facts, role | Facts chronology + red-flag themes |
| Trusts & Estates | Estate Litigation Facts Chronology | `skills/trusts-estates/estate-litigation-facts-chronology/SKILL.md` | Building a factual chronology for an estate or trust dispute | Documents, records, correspondence, dispute type, role | Source-cited factual chronology |
...
| Setup | Employment Cold-Start Interview | `skills/setup/employment-cold-start-interview/SKILL.md` | Interviewing an employment practice group to fill its practice profile | Access to an employment attorney or designee | Filled practice profile draft |
| Setup | Intellectual Property Cold-Start Interview | `skills/setup/ip-cold-start-interview/SKILL.md` | Interviewing an IP practice group to fill its practice profile | Access to an IP attorney or designee | Filled practice profile draft |
| Setup | AI Governance Cold-Start Interview | `skills/setup/ai-governance-cold-start-interview/SKILL.md` | Interviewing an AI-governance practice group to fill its practice profile | Access to an AI-governance attorney or designee | Filled practice profile draft |
| Setup | M&A Cold-Start Interview | `skills/setup/m-and-a-cold-start-interview/SKILL.md` | Interviewing an M&A practice group to fill its practice profile | Access to an M&A attorney or designee | Filled practice profile draft |
| Setup | Tax Cold-Start Interview | `skills/setup/tax-cold-start-interview/SKILL.md` | Interviewing a tax practice group to fill its practice profile | Access to a tax attorney or designee | Filled practice profile draft |
| Setup | Trusts and Estates Cold-Start Interview | `skills/setup/trusts-estates-cold-start-interview/SKILL.md` | Interviewing a trusts-and-estates practice group to fill its practice profile | Access to a trusts-and-estates attorney or designee | Filled practice profile draft |
| Setup | Real Estate Cold-Start Interview | `skills/setup/real-estate-cold-start-interview/SKILL.md` | Interviewing a real-estate practice group to fill its practice profile | Access to a real-estate attorney or designee | Filled practice profile draft |
| Setup | Securities and Capital Markets Cold-Start Interview | `skills/setup/securities-capital-markets-cold-start-interview/SKILL.md` | Interviewing a securities / capital-markets practice group to fill its practice profile | Access to a securities attorney or designee | Filled practice profile draft |
| Setup | Regulatory Cold-Start Interview | `skills/setup/regulatory-cold-start-interview/SKILL.md` | Interviewing a regulatory practice group to fill its practice profile | Access to a regulatory attorney or designee | Filled practice profile draft |
| Setup | Antitrust / Competition Cold-Start Interview | `skills/setup/antitrust-competition-cold-start-interview/SKILL.md` | Interviewing an antitrust / competition practice group to fill its practice profile | Access to an antitrust attorney or designee | Filled practice profile draft |
| Setup | Bankruptcy and Restructuring Cold-Start Interview | `skills/setup/bankruptcy-restructuring-cold-start-interview/SKILL.md` | Interviewing a bankruptcy / restructuring practice group to fill its practice profile | Access to a bankruptcy attorney or designee | Filled practice profile draft |
| Setup | Insurance Cold-Start Interview | `skills/setup/insurance-cold-start-interview/SKILL.md` | Interviewing an insurance practice group to fill its practice profile | Access to an insurance attorney or designee | Filled practice profile draft |
| Setup | Family Law Cold-Start Interview | `skills/setup/family-law-cold-start-interview/SKILL.md` | Interviewing a family-law practice group to fill its practice profile | Access to a family-law attorney or designee | Filled practice profile draft |
| Setup | Product Legal Cold-Start Interview | `skills/setup/product-legal-cold-start-interview/SKILL.md` | Interviewing a product-legal practice group to fill its practice profile | Access to a product-legal attorney or designee | Filled practice profile draft |
